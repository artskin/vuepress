...
<style>
  ...
  .sense-logo-path {
    fill: transparent;
    /* stroke-width: 1px; */
    stroke: #fff;stroke: url(#wpslinear);
  ...
  @keyframes senseLogoFill {
    from {
      fill: transparent;
    }
    to {
      fill: #FC464D;fill: #fff;fill: url(#wpslinear);
    }
  }
  .logo-box {
    position: relative;
